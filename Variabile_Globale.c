...
/* -------------------- Tablouri mari (200 B – 2 KB) -------------------- */

volatile uint16_t adc_buffer[1024] = {0};         // ~2 KB
unsigned int Sinus[100] = {
...
unsigned int DinteFierastrau[100] = {
    82,164,246,328,410,491,573,655,737,819,
...
float fir_coeffs_2[3] = {0.3f, 0.4f, 0.3f};
float iir_a_2[3] = {1.0f, -0.5f, 0.25f};
float iir_b_2[3] = {0.1f, 0.2f, 0.1f};

float x[3] = {0};
float y[3] = {0};
float b[3] = {0.067455f, 0.134911f, 0.067455f};
float a[3] = {1.0f, -1.14298f, 0.4128f};
...
volatile uint8_t FIR_Activ = 0;
volatile uint8_t IIR_Activ = 0;
